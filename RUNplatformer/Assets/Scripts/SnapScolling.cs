...
public class SnapScolling : MonoBehaviour
{
    [Range(1, 50)]
    [Header("Controlles")]
    public int panCount;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < panCount; i++)
        {
            ...
            {
                instPans[i] = Instantiate(pan6, transform, false);
            }
            else if (i == 7)
            {
                instPans[i] = Instantiate(pan7, transform, false);
            }
            if (i == 0) continue;
